...
(() => {
  ...
  OMS.refs = {
    ...
    phase3MainField: document.getElementById('phase3-main-field'),
    ...
    inagentHudGoal: document.getElementById('inagent-hud-goal'),
    inagentHudResources: document.getElementById('inagent-hud-resources'),
    inagentHudState: document.getElementById('inagent-hud-state'),
  ...
  OMS.constants = {
    ...
    LOCATIONS: [
      ...
      'LA', 'PARIS', 'BEIJING', 'SYDNEY', 'BERLIN', 'MIAMI', 'DOHA', 'REYKJAVIK', 'PRAGUE', 'LIMA',
      'LAGOS', 'OSAKA', 'MADRID', 'ZURICH', 'BOSTON', 'SINGAPORE', 'ISTANBUL', 'JAKARTA', 'MANILA', 'LISBON',
      'HANOI', 'ACCRA', 'NAIROBI', 'BRUSSELS', 'VIENNA', 'ROME', 'ATHENS', 'MEXICO', 'BOGOTA', 'DALLAS',
      'HOUSTON', 'PHOENIX', 'DENVER', 'SEATTLE', 'PORTLAND', 'MONTREAL', 'TORONTO', 'BUDAPEST', 'WARSAW', 'RIGA',
      'VILNIUS', 'TALLINN', 'DUBLIN', 'TBILISI', 'SOFIA', 'YEREVAN', 'TASHKENT', 'ALMATY', 'HELSINKI', 'STOCKHOLM',
      'COPENHAGEN', 'AUCKLAND', 'BRISBANE', 'MELBOURNE', 'PERTH', 'SANTIAGO', 'MONTEVIDEO', 'QUEBEC', 'ANTWERP', 'LUXOR',
      'KYOTO', 'BUSAN', 'ROTTERDAM', 'VALENCIA', 'NAPLES', 'FLORENCE', 'LYON', 'GENEVA', 'SALZBURG', 'KRAKOW',
      'GDANSK', 'CLUJ', 'SPLIT', 'MARSEILLE', 'NANTES', 'BILBAO', 'PORTO', 'BREMEN', 'HAMBURG', 'LEEDS',
      'BRISTOL', 'CARDIFF', 'GLASGOW', 'BELFAST', 'TUCSON', 'AUSTIN', 'DETROIT', 'OTTAWA', 'CALGARY', 'EDMONTON'
    ],
    ...
    SECRET_DEFS: [
      ...
      },
      {
        ...
        description: 'Ты прошел системный сброс после запретной кнопки.',
        category: 'achievement',
      },
      {
        id: 'signal_arcade',
        title: 'АРКАДНЫЙ МОДУЛЬ',
        hint: 'Спонсор реагирует на двойной клик.',
        description: 'Открыт скрытый аркадный модуль.',
        category: 'interactive',
        action: 'signal_arcade',
      },
      {
        id: 'sponsor_snake',
        title: 'ЗМЕЯ СПОНСОРА',
